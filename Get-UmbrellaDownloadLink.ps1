#Example of download url: https://disthost.umbrella.com/roaming/upgrade/win/stage/RoamingClient_WIN_3.0.328.msi

$baseurl = "https://disthost.umbrella.com/roaming/upgrade/win/stage/"
